...
function PalmTree({ side, delay = 0 }: { side: 'left' | 'right'; delay?: number }) {
  ...
  // Each frond: [startAngle, length, curl, color]
  const fronds: [number, number, string][] = [
    [-85, 'M0 0 C-20 -60 -60 -120 -110 -150 C-70 -130 -30 -90 -10 -30 Z', 'hsl(135, 55%, 38%)'],
    [-60, 'M0 0 C-40 -50 -100 -100 -160 -110 C-110 -100 -60 -70 -15 -25 Z', 'hsl(140, 50%, 42%)'],
    [-30, 'M0 0 C-50 -30 -120 -60 -170 -50 C-120 -55 -60 -40 -10 -15 Z', 'hsl(145, 45%, 40%)'],
    [0, 'M0 0 C-50 -10 -130 -10 -170 20 C-120 -5 -60 -10 -8 -5 Z', 'hsl(138, 48%, 36%)'],
    [85, 'M0 0 C20 -60 60 -120 110 -150 C70 -130 30 -90 10 -30 Z', 'hsl(130, 50%, 35%)'],
    [60, 'M0 0 C40 -50 100 -100 160 -110 C110 -100 60 -70 15 -25 Z', 'hsl(142, 52%, 40%)'],
    [30, 'M0 0 C50 -30 120 -60 170 -50 C120 -55 60 -40 10 -15 Z', 'hsl(133, 48%, 38%)'],
    [0, 'M0 0 C50 -10 130 -10 170 20 C120 -5 60 -10 8 -5 Z', 'hsl(148, 45%, 42%)'],
    [0, 'M0 0 C-5 -70 -10 -140 5 -180 C10 -140 8 -70 3 -20 Z', 'hsl(136, 55%, 36%)'],
  ];
